...
exports.calculateUserUpdatedLevel = exports.calculateUserInitialLevel = void 0;
const calculateUserInitialLevel = (details) => {
    const { injury_occured, diagnosed_by_medical_professional, pain_level, stiffness, swelling, has_pain_during_daily_activities, had_surgery, surgery_date, is_get_physiotherapy_before, is_previous_physiotherapy_completed, } = details;
...
exports.calculateUserInitialLevel = calculateUserInitialLevel;
const calculateUserUpdatedLevel = (currentLevel, previousScore, feedback) => {
    const { pain_level, stiffness, fatigue_level, strength_perception, functional_improvement, exercise_tolerance, swelling, } = feedback;
...
exports.calculateUserUpdatedLevel = calculateUserUpdatedLevel;
